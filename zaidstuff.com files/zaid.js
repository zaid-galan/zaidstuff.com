...
function change(){
    document.body.setAttribute('style','background:url(MonolithAttack18.gif);background-size:cover;');
    ...
    document.getElementsByTagName('iframe')[0].setAttribute('style','background-color:rgba(0,0,0,0.5);color:white;');
}
